#ifndef DISTANCE_BY_FREQUENCY_AVERAGE_H
#define DISTANCE_BY_FREQUENCY_AVERAGE_H
...
class  Distance_by_frequency_average: public Property
{
public:
	Distance_by_frequency_average(CowardVariables & cowa_store) :
		Property(cowa_store)
	{}


	explicit Distance_by_frequency_average(
...
protected:
	...
	Distance_by_frequency_average(const Distance_by_frequency_average&);
	Distance_by_frequency_average& operator = (const Distance_by_frequency_average&);
};
